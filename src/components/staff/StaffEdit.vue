        ...
        methods:{
            getUser (){
                axios({
                    ...
                    url: baseURL +`/employee/view?id=${this.$route.params.staff_id}`
                })
                    .then((response) => {
                        this.data = response.data
                        this.forming[0].name = response.data.surname
                        this.forming[1].name = response.data.name
                        this.forming[2].name = response.data.fathername
                        this.forming[3].name = response.data.telephone.replace(/(\w+)/g, '+7$1')
                        this.forming[4].name = response.data.email
                        this.forming[5].name = response.data.birth_date
                        this.forming[6].name = response.data.date_of_employment
                        this.forming[7].name = response.data.passport_series
                        this.forming[8].name = response.data.passport_number
                        this.forming[9].name = response.data.date_of_issue_of_passport
                        this.forming[10].name = response.data.passport_issued_by
                        this.forming[11].name = response.data.login
                    ...
                    if(this.forming[i].name == null || this.forming[i].name == '' || this.forming[i].name == undefined) {
                        ...
                        if (this.forming[i].fieldName === 'phone'){
                            ...
                            if (isPhoneValid === false){
                                ...
                                this.counter++
                                if(this.data.telephone === this.forming[i].name){
                        ...
                        if (this.forming[i].fieldName === 'passportwho'){
                            // eslint-disable-next-line no-useless-escape
                            let emailCodeRegex = new RegExp(/^([А-Я]{1})+([А-Яа-я]№?.?,?-? ?)+[А-Яа-я]{1}$/)
                        ...
                        if (this.forming[i].type === 'date'){
                            ...
                            if (ourDateparse.setHours(0,0,0,0) > today.setHours(0,0,0,0)){
                                ...
                                this.counter++
                                if(this.data.date_of_issue_of_passport === this.forming[9].name){
                                    this.user.date_of_issue_of_passport = this.forming[9].name
                                }
                                else{
                                    this.user.date_of_issue_of_passport = this.forming[9].name.replace( /-/g, "." )
                                        .replace(/(\w+).(\w+).(\w+)/i, '$3.$2.$1')
                                }
                                if(this.data.birth_date === this.forming[5].name){
                                    this.user.birth_date = this.forming[5].name
                                }
                                else{
                                    this.user.birth_date = this.forming[5].name.replace( /-/g, "." )
                                        .replace(/(\w+).(\w+).(\w+)/i, '$3.$2.$1')
                                }
                                if(this.data.date_of_employment === this.forming[6].name){
                                    this.user.date_of_employment = this.forming[6].name
                                }
                                else{
            ...
            regComplited (){
                if (this.counter === 13){
                    axios({
                        ...
                        url: baseURL +`/employee/update?id=${this.$route.params.staff_id}`
                    })
                        .then((response) => {
                            // eslint-disable-next-line no-console
