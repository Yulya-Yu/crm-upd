...
<select  class="dropbtn">
    ...
    <div class="staff-cards-container" >
        <div class="staff-card" v-for="delStaff in allDeletedStaff" :key="delStaff.id" :delStaff="delStaff">
            <div class="header" >
                <div class="employee" >
            ...
            <div class="options-container">
                   ...
                   <div id="options-content">
                     <button class="delete-btn" @click="showModal(delStaff.id)"><img src="@/assets/del.svg" class="options-icon">Восстановить</button> 
                   </div>
                                <div class="modal" v-show="selectedId == delStaff.id">
                                     ...
                                     <div class="confirm-btns">
                                        <button @click="(restoreStaff(delStaff.id)), (closeModal), (activateConfirm=true)" class="delete-btn-modal">Да</button>
            ...
            <div class="contacts">
                <div class="contact-data">
                    ...
                    <h5>Контакты:</h5>
                    <p><img src="@/assets/tel.svg" class="phone-icon"/>+7{{delStaff.telephone}}</p>
                    <p><img src="@/assets/email.svg" class="email-icon"/>{{delStaff.email}}</p>
                </div>
                <div class="passport">
                    <h5>Паспорт</h5>
    ...
    <router-link to="/StaffList"><button class="staff-add-btn"  @click="goToDeleted()">Сотрудники</button></router-link>
    <router-view />
</div>
</template>
